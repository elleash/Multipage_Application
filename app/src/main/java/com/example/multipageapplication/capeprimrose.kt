...
class capeprimrose : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_capeprimrose)
        ...
        symbolBtn.setOnClickListener {
            ...
            newTxt.text = "Although it has no official meaning, this plant can illustrate " +
                    "the power of \npersistance and transformation."
