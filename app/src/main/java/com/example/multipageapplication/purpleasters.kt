...
class purpleasters : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_purpleasters)
        ...
        symbolBtn.setOnClickListener {
            ...
            newTxt.text = "Asters have different meanings based on their color. With purple" +
                    " asters, \nthey symbolize royalty, dignity and admiration."
