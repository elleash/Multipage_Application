...
class oxalis : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_oxalis)
        ...
        symbolBtn.setOnClickListener {
            ...
            newTxt.text = "In Ireland, oxalis have an important part in history" +
                    "\nin regards to religion and politics. Similar to " +
                    "the four leaf clover \nthey believe that the cloves symbolize" +
                    "\nhope, faith and love."
