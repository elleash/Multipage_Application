...
class dahlias : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dahlias)
        ...
        symbolBtn.setOnClickListener {
            ...
            newTxt.text = "In the Victorian Era, dahlias were given as a symbol of" +
                    "\nof devotion, love, beauty and dignity. \nAdditionally, it can" +
                    " also mean 'finding inner strength'."
